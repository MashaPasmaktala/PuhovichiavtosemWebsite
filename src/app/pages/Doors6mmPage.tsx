...
const products: Product[] = [
  {
    id: 1,
    name: 'Дверь стеклянная прозрачная 6 мм',
    image: '/images/6mm.jpg',
    description: 'Межкомнатная дверь из закаленного прозрачного стекла.',
    sizes: [
      { size: '600x2000 мм', price: '8 500 руб' },
      { size: '700x2000 мм', price: '9 200 руб' },
      { size: '800x2000 мм', price: '10 000 руб' },
      { size: '900x2000 мм', price: '11 500 руб' },
    ],
    features: [
      'Закаленное 6 мм',
      'Обработка кромок',
  ...
  {
    id: 2,
    name: 'Дверь стеклянная матовая 6 мм',
    image: '/images/6mm-matt.jpg',
    description: 'Дверь с матовым стеклом для приватности.',
    sizes: [
      { size: '600x2000 мм', price: '9 000 руб' },
      { size: '700x2000 мм', price: '9 800 руб' },
      { size: '800x2000 мм', price: '10 700 руб' },
      { size: '900x2000 мм', price: '12 200 руб' },
    ],
    features: [
      'Матовое стекло',
      'Полировка',
  ...
  {
    id: 3,
    name: 'Дверь с фотопечатью 6 мм',
    image: '/images/6mm-print.jpg',
    description: 'Дверь с УФ-печатью любого изображения.',
    sizes: [
      { size: '600x2000 мм', price: '12 500 руб' },
      { size: '700x2000 мм', price: '13 500 руб' },
      { size: '800x2000 мм', price: '14 800 руб' },
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8 py-8 md:py-12">
          ...
          <div className="text-center mb-12 md:mb-16 relative z-10">
            ...
            <div className="text-base sm:text-lg md:text-xl text-slate-400 max-w-3xl mx-auto px-2 md:px-4 font-medium">
              Стеклянные двери из закаленного стекла толщиной 6 мм для межкомнатных проемов
            </div>
          </div>
            ...
            {[
              {
                ...
                description: "Термическая обработка 680°C, прочность в 5 раз выше",
                icon: Shield
              },
              {
                title: "Безопасность",
                description: "При разрушении образует безопасные тупые осколки",
                icon: Zap
              },
              {
                title: "Гарантия 3 года",
                description: "Официальная гарантия на всю продукцию и монтаж",
                icon: Sparkles
              }
            ].map((feature, index) => {
            ...
            <div className="relative bg-gradient-to-br from-[#1a0000] via-[#0a0000] to-[#1a0000] border-2 border-[#300000] rounded-3xl p-6 sm:p-8 md:p-12 text-center overflow-hidden group">
              ...
              <div className="relative">
                <h2 className="text-xl sm:text-2xl md:text-3xl font-black text-[#b50202] mb-4 md:mb-6 drop-shadow-[0_0_10px_rgba(181,2,2,0.5)]">
                  НУЖНА КОНСУЛЬТАЦИЯ ПО ДВЕРЯМ 6 ММ?
                </h2>
                
                <div className="text-base sm:text-lg md:text-xl text-slate-300 mb-6 md:mb-8 max-w-2xl mx-auto">
                  Наши специалисты помогут выбрать оптимальный размер и рассчитают стоимость
                </div>
